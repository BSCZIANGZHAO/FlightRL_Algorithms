...
def parser():
    ...
    parser.add_argument('-w', '--weight', type=str,
                        default='./saved/2024-03-07-01-20-29/2024-03-07-01-20-29_7000000.zip',
                        help='trained weight path')
    return parser

def td3_api(train=0, render=0, save_interval=1000000,
