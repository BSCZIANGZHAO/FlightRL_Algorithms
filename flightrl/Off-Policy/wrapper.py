...
class FlightEnvVec(VecEnv):
    ...
    def step(self, action):
        # print(type(action))
        # print(self._observation.shape, self._reward.shape, self._done.shape, self._extraInfo.shape)
    ...
    def step_wait(self):
        ...
        for i, action in enumerate(self._actions):
            obs, reward, done, info = self.wrapper.step(action, self._observation[i],
                                                        self._reward[i], self._done[i], self._extraInfo[i])
        ...
        self._observation = np.array(observations)
        self._reward = np.array(rewards)
