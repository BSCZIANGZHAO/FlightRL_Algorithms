    ...
    def learn(self, total_timesteps, callback=None,
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                # convert unscaled_action from (4,) to (1, 4)
                temp = unscaled_action
                unscaled_action = unscaled_action.reshape(1, -1)
                new_obs, reward, done, info = self.env.step(unscaled_action)
                print(f"Observation: {new_obs}, Reward: {reward}, Done: {done}, Info: {info}")
                self.num_timesteps += 1
                unscaled_action = temp
                ...
                for i_info in info:
                    maybe_ep_info = i_info.get('episode')
                ...
                if done:
                    ...
                    for i_info in info:
                        maybe_is_success = i_info.get('is_success')
